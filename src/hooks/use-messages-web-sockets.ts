...
interface useMessagesWebsSocketsParams {
    roomId: string
}
    ...
    useEffect(() => {
        ...
        ws.onmessage = (event) => {
            ...
            switch (data.kind) {
                ...
                case 'message_reaction_incresead':
